...
public class Genome implements Comparable<Genome> {
    ...
    //so sánh trường currentFitness của thể hiện Genome này với thể hiện Genome được chỉ định o. 
	//Trả về 1 nếu currentFitness của thể hiện này nhỏ hơn của o, -1 nếu nó lớn hơn của o, và 0 nếu chúng bằng nhau.
	@Override
    ...
    //trả về true nếu trường currentFitness nhỏ hơn hoặc bằng giá trị
	//fitness được chỉ định nhân với 100, và false nếu không phải.
	...
	//tính toán dựa trên số giá trị duy nhất trong mỗi hàng, cột và ô vuông 3x3 của câu đố Sudoku
